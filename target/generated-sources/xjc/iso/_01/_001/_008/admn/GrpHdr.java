 ...
 *       &lt;sequence&gt;
 *         &lt;element name="MsgId" type="{admn.008.001.01}Max35Text"/&gt;
 *         &lt;element name="CreDtTm" type="{admn.008.001.01}ISODateTime"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GrpHdr)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GrpHdr that = ((GrpHdr) object);
        {
            String lhsMsgId;
