...
/**
 * <p>Java class for ParticipantSignOff_TCH complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ParticipantSignOff_TCH"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "ParticipantSignOff_TCH", propOrder = {
    "ptcptIds"
})
public class ParticipantSignOffTCH
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ParticipantSignOffTCH)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ParticipantSignOffTCH that = ((ParticipantSignOffTCH) object);
        {
