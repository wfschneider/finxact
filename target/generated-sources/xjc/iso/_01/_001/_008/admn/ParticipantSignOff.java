...
/**
 * <p>Java class for ParticipantSignOff complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ParticipantSignOff"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "ParticipantSignOff", propOrder = {
    "ptcptIds"
})
public class ParticipantSignOff
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ParticipantSignOff)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ParticipantSignOff that = ((ParticipantSignOff) object);
        {
