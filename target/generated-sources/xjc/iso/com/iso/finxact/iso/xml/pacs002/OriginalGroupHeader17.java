 ...
 *         &lt;element name="OrgnlMsgNmId" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.10}OrigMsgName_2019"/&gt;
    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof OriginalGroupHeader17)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final OriginalGroupHeader17 that = ((OriginalGroupHeader17) object);
        {
