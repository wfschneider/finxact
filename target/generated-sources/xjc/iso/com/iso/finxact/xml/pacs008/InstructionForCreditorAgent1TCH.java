...
/**
 * <p>Java class for InstructionForCreditorAgent1_TCH complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="InstructionForCreditorAgent1_TCH"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="Cd" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.08}Instruction3Code_TCH"/&gt;
 *         &lt;element name="InstrInf" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.08}Max140Text_TCH"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "InstructionForCreditorAgent1_TCH", propOrder = {
    "cd",
    "instrInf"
})
public class InstructionForCreditorAgent1TCH
    implements Equals, HashCode, ToString
{

    @XmlElement(name = "Cd", required = true)
    @XmlSchemaType(name = "string")
    protected Instruction3CodeTCH cd;
     ...
     * @return
     *     possible object is
     *     {@link Instruction3CodeTCH }
     *     
     */
    public Instruction3CodeTCH getCd() {
        return cd;
    }
     ...
     *     
     */
    public void setCd(Instruction3CodeTCH value) {
        this.cd = value;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof InstructionForCreditorAgent1TCH)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final InstructionForCreditorAgent1TCH that = ((InstructionForCreditorAgent1TCH) object);
        {
            Instruction3CodeTCH lhsCd;
            lhsCd = this.getCd();
            Instruction3CodeTCH rhsCd;
            rhsCd = that.getCd();
