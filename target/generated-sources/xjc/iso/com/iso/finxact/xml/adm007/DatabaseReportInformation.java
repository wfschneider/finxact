...
/**
 * <p>Java class for DatabaseReportInformation complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="DatabaseReportInformation"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="RptCd" type="{admn.007.001.01}ReportCode"/&gt;
...
@XmlType(name = "DatabaseReportInformation", propOrder = {
    "rptCd",
    "instrId",
    "instgAgt",
    "instdAgt"
})
public class DatabaseReportInformation
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DatabaseReportInformation)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DatabaseReportInformation that = ((DatabaseReportInformation) object);
        {
            ReportCode lhsRptCd;
