 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Rsn" type="{urn:iso:std:iso:20022:tech:xsd:camt.029.001.09}CancellationStatusReason3Choice" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CancellationStatusReason4)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final CancellationStatusReason4 that = ((CancellationStatusReason4) object);
        {
            CancellationStatusReason3Choice lhsRsn;
            lhsRsn = this.getRsn();
            CancellationStatusReason3Choice rhsRsn;
            rhsRsn = that.getRsn();
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            CancellationStatusReason3Choice theRsn;
            theRsn = this.getRsn();
