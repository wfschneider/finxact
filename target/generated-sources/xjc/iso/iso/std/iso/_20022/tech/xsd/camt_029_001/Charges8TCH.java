...
/**
 * <p>Java class for Charges8_TCH complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="Charges8_TCH"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "Charges8_TCH", propOrder = {
    "amt",
    "agt"
})
public class Charges8TCH
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof Charges8TCH)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final Charges8TCH that = ((Charges8TCH) object);
        {
