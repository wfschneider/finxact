 ...
 * VocaLink
 * 
 * <p>Java class for FIToFIPaymentCancellationRequestV08_DRAFT complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="FIToFIPaymentCancellationRequestV08_DRAFT"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="Assgnmt" type="{urn:iso:std:iso:20022:tech:xsd:camt.056.001.08}CaseAssignment5"/&gt;
 *         &lt;element name="Case" type="{urn:iso:std:iso:20022:tech:xsd:camt.056.001.08}Case5"/&gt;
 *         &lt;element name="Undrlyg" type="{urn:iso:std:iso:20022:tech:xsd:camt.056.001.08}UnderlyingTransaction23"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "FIToFIPaymentCancellationRequestV08_DRAFT", propOrder = {
    "assgnmt",
    "_case",
    "undrlyg"
})
public class FIToFIPaymentCancellationRequestV08DRAFT
    implements Equals, HashCode, ToString
{
    ...
    protected UnderlyingTransaction23 undrlyg;
     ...
     *     
     */
    public UnderlyingTransaction23 getUndrlyg() {
        return undrlyg;
    }
     ...
     *     
     */
    public void setUndrlyg(UnderlyingTransaction23 value) {
        this.undrlyg = value;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof FIToFIPaymentCancellationRequestV08DRAFT)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final FIToFIPaymentCancellationRequestV08DRAFT that = ((FIToFIPaymentCancellationRequestV08DRAFT) object);
        {
        ...
        {
            UnderlyingTransaction23 lhsUndrlyg;
            lhsUndrlyg = this.getUndrlyg();
            UnderlyingTransaction23 rhsUndrlyg;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            UnderlyingTransaction23 theUndrlyg;
