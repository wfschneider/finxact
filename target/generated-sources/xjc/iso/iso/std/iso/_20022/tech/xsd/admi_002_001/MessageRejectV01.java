    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof MessageRejectV01)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final MessageRejectV01 that = ((MessageRejectV01) object);
        {
            MessageReference lhsRltdRef;
            lhsRltdRef = this.getRltdRef();
            MessageReference rhsRltdRef;
