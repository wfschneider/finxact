 ...
 *       &lt;sequence&gt;
 *         &lt;element name="AnyBIC" type="{urn:iso:std:iso:20022:tech:xsd:remt.001.001.04}AnyBICDec2014Identifier" minOccurs="0"/&gt;
 *         &lt;element name="LEI" type="{urn:iso:std:iso:20022:tech:xsd:remt.001.001.04}LEIIdentifier" minOccurs="0"/&gt;
 *         &lt;element name="Othr" type="{urn:iso:std:iso:20022:tech:xsd:remt.001.001.04}GenericOrganisationIdentification1" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final OrganisationIdentification29 that = ((OrganisationIdentification29) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "anyBIC", lhsAnyBIC), LocatorUtils.property(thatLocator, "anyBIC", rhsAnyBIC), lhsAnyBIC, rhsAnyBIC)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            ...
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "anyBIC", theAnyBIC), currentHashCode, theAnyBIC);
        }
        {
            String theLEI;
            theLEI = this.getLEI();
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            String theAnyBIC;
            theAnyBIC = this.getAnyBIC();
            strategy.appendField(locator, this, "anyBIC", buffer, theAnyBIC);
        }
        {
            String theLEI;
            theLEI = this.getLEI();
