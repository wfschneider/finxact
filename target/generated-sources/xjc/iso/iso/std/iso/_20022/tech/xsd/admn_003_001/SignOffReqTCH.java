...
/**
 * <p>Java class for SignOffReq_TCH complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="SignOffReq_TCH"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="InstrId" type="{urn:iso:std:iso:20022:tech:xsd:admn.003.001.01}Max35Text_TCH_2"/&gt;
...
@XmlType(name = "SignOffReq_TCH", propOrder = {
    "instrId",
    "instgAgt",
    "instdAgt"
})
public class SignOffReqTCH
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof SignOffReqTCH)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final SignOffReqTCH that = ((SignOffReqTCH) object);
        {
            String lhsInstrId;
