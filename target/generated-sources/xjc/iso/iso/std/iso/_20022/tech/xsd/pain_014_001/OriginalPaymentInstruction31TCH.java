...
/**
 * <p>Java class for OriginalPaymentInstruction31_TCH complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="OriginalPaymentInstruction31_TCH"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="OrgnlPmtInfId" type="{urn:iso:std:iso:20022:tech:xsd:pain.014.001.07}Max35Text"/&gt;
 *         &lt;element name="TxInfAndSts" type="{urn:iso:std:iso:20022:tech:xsd:pain.014.001.07}PaymentTransaction98_TCH"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "OriginalPaymentInstruction31_TCH", propOrder = {
    "orgnlPmtInfId",
    "txInfAndSts"
})
public class OriginalPaymentInstruction31TCH
    implements Equals, HashCode, ToString
{
    ...
    protected PaymentTransaction98TCH txInfAndSts;
     ...
     * @return
     *     possible object is
     *     {@link PaymentTransaction98TCH }
     *     
     */
    public PaymentTransaction98TCH getTxInfAndSts() {
        return txInfAndSts;
    }
     ...
     *     
     */
    public void setTxInfAndSts(PaymentTransaction98TCH value) {
        this.txInfAndSts = value;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof OriginalPaymentInstruction31TCH)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final OriginalPaymentInstruction31TCH that = ((OriginalPaymentInstruction31TCH) object);
        {
        ...
        {
            PaymentTransaction98TCH lhsTxInfAndSts;
            lhsTxInfAndSts = this.getTxInfAndSts();
            PaymentTransaction98TCH rhsTxInfAndSts;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            PaymentTransaction98TCH theTxInfAndSts;
