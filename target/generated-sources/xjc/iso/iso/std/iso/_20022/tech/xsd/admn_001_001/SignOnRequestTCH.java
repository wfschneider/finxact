 ...
 * VocaLink
 * 
 * <p>Java class for SignOnRequest_TCH complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="SignOnRequest_TCH"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="GrpHdr" type="{urn:iso:std:iso:20022:tech:xsd:admn.001.001.01}GrpHdr_TCH"/&gt;
 *         &lt;element name="SignOnReq" type="{urn:iso:std:iso:20022:tech:xsd:admn.001.001.01}SignOnReq_TCH"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "SignOnRequest_TCH", propOrder = {
    "grpHdr",
    "signOnReq"
})
public class SignOnRequestTCH
    implements Equals, HashCode, ToString
{
    ...
    protected SignOnReqTCH signOnReq;
     ...
     *     
     */
    public SignOnReqTCH getSignOnReq() {
        return signOnReq;
    }
     ...
     *     
     */
    public void setSignOnReq(SignOnReqTCH value) {
        this.signOnReq = value;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof SignOnRequestTCH)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final SignOnRequestTCH that = ((SignOnRequestTCH) object);
        {
            GrpHdrTCH lhsGrpHdr;
        ...
        {
            SignOnReqTCH lhsSignOnReq;
            lhsSignOnReq = this.getSignOnReq();
            SignOnReqTCH rhsSignOnReq;
