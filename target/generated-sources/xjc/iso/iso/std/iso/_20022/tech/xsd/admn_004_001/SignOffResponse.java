 ...
 * VocaLink
 * 
 * <p>Java class for SignOffResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="SignOffResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "SignOffResponse", propOrder = {
    "grpHdr",
    "signOffResp"
})
    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof SignOffResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final SignOffResponse that = ((SignOffResponse) object);
        {
            GrpHdr lhsGrpHdr;
        ...
        {
            SignOffResp lhsSignOffResp;
            lhsSignOffResp = this.getSignOffResp();
            SignOffResp rhsSignOffResp;
