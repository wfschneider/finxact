...
/**
 * <p>Java class for PartyIdentification135_TCH_5 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="PartyIdentification135_TCH_5"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="Id" type="{urn:iso:std:iso:20022:tech:xsd:pain.013.001.07}Party38Choice_TCH_4" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "PartyIdentification135_TCH_5", propOrder = {
    "nm",
    "pstlAdr",
    "id"
})
public class PartyIdentification135TCH5
    implements Equals, HashCode, ToString
{
    ...
    @XmlElement(name = "Id")
    protected Party38ChoiceTCH4 id;
     ...
     * @return
     *     possible object is
     *     {@link Party38ChoiceTCH4 }
     *     
     */
    public Party38ChoiceTCH4 getId() {
        return id;
    }
     ...
     *     
     */
    public void setId(Party38ChoiceTCH4 value) {
        this.id = value;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof PartyIdentification135TCH5)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final PartyIdentification135TCH5 that = ((PartyIdentification135TCH5) object);
        {
            String lhsNm;
            lhsNm = this.getNm();
            String rhsNm;
        ...
        {
            Party38ChoiceTCH4 lhsId;
            lhsId = this.getId();
            Party38ChoiceTCH4 rhsId;
            rhsId = that.getId();
