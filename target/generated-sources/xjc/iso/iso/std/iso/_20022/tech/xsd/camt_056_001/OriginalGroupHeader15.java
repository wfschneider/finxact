 ...
 *         &lt;element name="OrgnlMsgNmId" type="{urn:iso:std:iso:20022:tech:xsd:camt.056.001.08}OrigMsgName_2019"/&gt;
    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof OriginalGroupHeader15)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final OriginalGroupHeader15 that = ((OriginalGroupHeader15) object);
        {
