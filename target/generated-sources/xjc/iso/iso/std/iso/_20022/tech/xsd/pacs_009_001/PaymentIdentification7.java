 ...
 *       &lt;sequence&gt;
 *         &lt;element name="InstrId" type="{urn:iso:std:iso:20022:tech:xsd:pacs.009.001.08}Max35Text" minOccurs="0"/&gt;
 *         &lt;element name="EndToEndId" type="{urn:iso:std:iso:20022:tech:xsd:pacs.009.001.08}Max35Text"/&gt;
 *         &lt;element name="TxId" type="{urn:iso:std:iso:20022:tech:xsd:pacs.009.001.08}Max35Text" minOccurs="0"/&gt;
    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof PaymentIdentification7)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final PaymentIdentification7 that = ((PaymentIdentification7) object);
        {
            String lhsInstrId;
