...
/**
 * <p>Java class for IdentificationInformation2_TCH complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="IdentificationInformation2_TCH"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="Acct" type="{urn:iso:std:iso:20022:tech:xsd:acmt.022.001.02}AccountIdentification4Choice"/&gt;
...
@XmlType(name = "IdentificationInformation2_TCH", propOrder = {
    "acct",
    "agt"
})
public class IdentificationInformation2TCH
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof IdentificationInformation2TCH)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final IdentificationInformation2TCH that = ((IdentificationInformation2TCH) object);
        {
