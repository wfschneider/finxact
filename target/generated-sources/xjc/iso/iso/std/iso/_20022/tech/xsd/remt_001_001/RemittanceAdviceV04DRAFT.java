 ...
 * VocaLink
 * 
 * <p>Java class for RemittanceAdviceV04_DRAFT complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="RemittanceAdviceV04_DRAFT"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="GrpHdr" type="{urn:iso:std:iso:20022:tech:xsd:remt.001.001.04}GroupHeader79"/&gt;
 *         &lt;element name="RmtInf" type="{urn:iso:std:iso:20022:tech:xsd:remt.001.001.04}RemittanceInformation19"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "RemittanceAdviceV04_DRAFT", propOrder = {
    "grpHdr",
    "rmtInf"
})
public class RemittanceAdviceV04DRAFT
    implements Equals, HashCode, ToString
{
    ...
    protected RemittanceInformation19 rmtInf;
     ...
     *     
     */
    public void setGrpHdr(GroupHeader79 value) {
        this.grpHdr = value;
    }
     ...
     *     
     */
    public RemittanceInformation19 getRmtInf() {
        return rmtInf;
    }
     ...
     *     
     */
    public void setRmtInf(RemittanceInformation19 value) {
        this.rmtInf = value;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof RemittanceAdviceV04DRAFT)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final RemittanceAdviceV04DRAFT that = ((RemittanceAdviceV04DRAFT) object);
        {
            GroupHeader79 lhsGrpHdr;
            lhsGrpHdr = this.getGrpHdr();
            GroupHeader79 rhsGrpHdr;
        ...
        {
            RemittanceInformation19 lhsRmtInf;
            lhsRmtInf = this.getRmtInf();
            RemittanceInformation19 rhsRmtInf;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            RemittanceInformation19 theRmtInf;
