 ...
 *         &lt;element name="SchmeNm" type="{urn:iso:std:iso:20022:tech:xsd:remt.001.001.04}OrganisationIdentificationSchemeName1Choice" minOccurs="0"/&gt;
    ...
    implements Equals, HashCode, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            OrganisationIdentificationSchemeName1Choice theSchmeNm;
            theSchmeNm = this.getSchmeNm();
            strategy.appendField(locator, this, "schmeNm", buffer, theSchmeNm);
        }
        {
            String theIssr;
            theIssr = this.getIssr();
