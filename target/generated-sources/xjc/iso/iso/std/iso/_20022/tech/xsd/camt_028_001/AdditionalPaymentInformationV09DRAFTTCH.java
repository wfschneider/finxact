 ...
 * VocaLink
 * 
 * <p>Java class for AdditionalPaymentInformationV09_DRAFT_TCH complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AdditionalPaymentInformationV09_DRAFT_TCH"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="Assgnmt" type="{urn:iso:std:iso:20022:tech:xsd:camt.028.001.09}CaseAssignment5_TCH"/&gt;
 *         &lt;element name="Case" type="{urn:iso:std:iso:20022:tech:xsd:camt.028.001.09}Case5_TCH"/&gt;
 *         &lt;element name="Undrlyg" type="{urn:iso:std:iso:20022:tech:xsd:camt.028.001.09}UnderlyingTransaction5Choice_TCH"/&gt;
 *         &lt;element name="Inf" type="{urn:iso:std:iso:20022:tech:xsd:camt.028.001.09}PaymentComplementaryInformation8_TCH"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "AdditionalPaymentInformationV09_DRAFT_TCH", propOrder = {
    "assgnmt",
    "_case",
    "undrlyg",
    "inf"
})
public class AdditionalPaymentInformationV09DRAFTTCH
    implements Equals, HashCode, ToString
{
    ...
    protected PaymentComplementaryInformation8TCH inf;
     ...
     * @return
     *     possible object is
     *     {@link PaymentComplementaryInformation8TCH }
     *     
     */
    public PaymentComplementaryInformation8TCH getInf() {
        return inf;
    }
     ...
     *     
     */
    public void setInf(PaymentComplementaryInformation8TCH value) {
        this.inf = value;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof AdditionalPaymentInformationV09DRAFTTCH)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final AdditionalPaymentInformationV09DRAFTTCH that = ((AdditionalPaymentInformationV09DRAFTTCH) object);
        {
        ...
        {
            PaymentComplementaryInformation8TCH lhsInf;
            lhsInf = this.getInf();
            PaymentComplementaryInformation8TCH rhsInf;
            rhsInf = that.getInf();
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            PaymentComplementaryInformation8TCH theInf;
            theInf = this.getInf();
