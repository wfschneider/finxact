 ...
 *         &lt;element name="OrgnlMsgNmId" type="{urn:iso:std:iso:20022:tech:xsd:pain.014.001.07}OrigMsgName_2019"/&gt;
    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof OriginalGroupInformation30)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final OriginalGroupInformation30 that = ((OriginalGroupInformation30) object);
        {
