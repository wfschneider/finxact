 ...
 * VocaLink
 * 
 * <p>Java class for BusinessApplicationHeaderV01_TCH complex type.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Fr" type="{urn:iso:std:iso:20022:tech:xsd:head.001.001.01}Party9Choice_TCH"/&gt;
 *         &lt;element name="To" type="{urn:iso:std:iso:20022:tech:xsd:head.001.001.01}Party9Choice_TCH_2"/&gt;
 ...
 *         &lt;element name="CpyDplct" type="{urn:iso:std:iso:20022:tech:xsd:head.001.001.01}CopyDuplicate1Code_TCH" minOccurs="0"/&gt;
...
@XmlType(name = "BusinessApplicationHeaderV01_TCH", propOrder = {
    "fr",
    "to",
    "bizMsgIdr",
    "msgDefIdr",
...
public class BusinessApplicationHeaderV01TCH
    implements Equals, HashCode, ToString
{

    @XmlElement(name = "Fr", required = true)
    protected Party9ChoiceTCH fr;
    @XmlElement(name = "To", required = true)
    protected Party9ChoiceTCH2 to;
    ...
    @XmlSchemaType(name = "string")
    protected CopyDuplicate1CodeTCH cpyDplct;
     ...
     * @return
     *     possible object is
     *     {@link Party9ChoiceTCH }
     *     
     */
    public Party9ChoiceTCH getFr() {
        return fr;
    }
     ...
     *     
     */
    public void setFr(Party9ChoiceTCH value) {
        this.fr = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link Party9ChoiceTCH2 }
     *     
     */
    public Party9ChoiceTCH2 getTo() {
        return to;
    }
     ...
     *     
     */
    public void setTo(Party9ChoiceTCH2 value) {
        this.to = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link CopyDuplicate1CodeTCH }
     *     
     */
    public CopyDuplicate1CodeTCH getCpyDplct() {
        return cpyDplct;
    }
     ...
     *     
     */
    public void setCpyDplct(CopyDuplicate1CodeTCH value) {
        this.cpyDplct = value;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof BusinessApplicationHeaderV01TCH)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final BusinessApplicationHeaderV01TCH that = ((BusinessApplicationHeaderV01TCH) object);
        {
            Party9ChoiceTCH lhsFr;
            lhsFr = this.getFr();
            Party9ChoiceTCH rhsFr;
            rhsFr = that.getFr();
        ...
        {
            Party9ChoiceTCH2 lhsTo;
            lhsTo = this.getTo();
            Party9ChoiceTCH2 rhsTo;
            rhsTo = that.getTo();
        ...
        {
            CopyDuplicate1CodeTCH lhsCpyDplct;
            lhsCpyDplct = this.getCpyDplct();
            CopyDuplicate1CodeTCH rhsCpyDplct;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            CopyDuplicate1CodeTCH theCpyDplct;
