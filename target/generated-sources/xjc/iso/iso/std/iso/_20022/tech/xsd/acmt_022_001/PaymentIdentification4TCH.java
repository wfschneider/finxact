...
/**
 * <p>Java class for PaymentIdentification4_TCH complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="PaymentIdentification4_TCH"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="InstrId" type="{urn:iso:std:iso:20022:tech:xsd:acmt.022.001.02}Max35Text"/&gt;
...
@XmlType(name = "PaymentIdentification4_TCH", propOrder = {
    "instrId",
    "endToEndId",
    "txId"
})
public class PaymentIdentification4TCH
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof PaymentIdentification4TCH)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final PaymentIdentification4TCH that = ((PaymentIdentification4TCH) object);
        {
            String lhsInstrId;
