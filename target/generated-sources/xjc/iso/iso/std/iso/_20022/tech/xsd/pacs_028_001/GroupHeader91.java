 ...
 *       &lt;sequence&gt;
 *         &lt;element name="MsgId" type="{urn:iso:std:iso:20022:tech:xsd:pacs.028.001.03}Max35Text"/&gt;
    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GroupHeader91)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GroupHeader91 that = ((GroupHeader91) object);
        {
            String lhsMsgId;
