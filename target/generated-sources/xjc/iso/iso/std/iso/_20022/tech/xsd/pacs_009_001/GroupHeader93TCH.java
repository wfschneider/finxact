...
/**
 * <p>Java class for GroupHeader93_TCH complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="GroupHeader93_TCH"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="MsgId" type="{urn:iso:std:iso:20022:tech:xsd:pacs.009.001.08}Max35Text_TCH"/&gt;
 *         &lt;element name="CreDtTm" type="{urn:iso:std:iso:20022:tech:xsd:pacs.009.001.08}ISODateTime"/&gt;
 *         &lt;element name="NbOfTxs" type="{urn:iso:std:iso:20022:tech:xsd:pacs.009.001.08}Max15NumericText"/&gt;
 *         &lt;element name="TtlIntrBkSttlmAmt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.009.001.08}ActiveCurrencyAndAmount"/&gt;
 *         &lt;element name="IntrBkSttlmDt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.009.001.08}ISODate"/&gt;
 *         &lt;element name="SttlmInf" type="{urn:iso:std:iso:20022:tech:xsd:pacs.009.001.08}SettlementInstruction4_TCH"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "GroupHeader93_TCH", propOrder = {
    "msgId",
    "creDtTm",
    "nbOfTxs",
    "ttlIntrBkSttlmAmt",
    ...
    implements Equals, HashCode, ToString
{
    ...
    protected SettlementInstruction4TCH sttlmInf;
     ...
     * @return
     *     possible object is
     *     {@link SettlementInstruction4TCH }
     *     
     */
    public SettlementInstruction4TCH getSttlmInf() {
        return sttlmInf;
    }
     ...
     *     
     */
    public void setSttlmInf(SettlementInstruction4TCH value) {
        this.sttlmInf = value;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GroupHeader93TCH)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GroupHeader93TCH that = ((GroupHeader93TCH) object);
        {
            String lhsMsgId;
        ...
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "ttlIntrBkSttlmAmt", lhsTtlIntrBkSttlmAmt), LocatorUtils.property(thatLocator, "ttlIntrBkSttlmAmt", rhsTtlIntrBkSttlmAmt), lhsTtlIntrBkSttlmAmt, rhsTtlIntrBkSttlmAmt)) {
                return false;
            }
        }
        {
        ...
        {
            SettlementInstruction4TCH lhsSttlmInf;
            lhsSttlmInf = this.getSttlmInf();
            SettlementInstruction4TCH rhsSttlmInf;
            rhsSttlmInf = that.getSttlmInf();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "sttlmInf", lhsSttlmInf), LocatorUtils.property(thatLocator, "sttlmInf", rhsSttlmInf), lhsSttlmInf, rhsSttlmInf)) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "ttlIntrBkSttlmAmt", theTtlIntrBkSttlmAmt), currentHashCode, theTtlIntrBkSttlmAmt);
        }
        {
        ...
        {
            SettlementInstruction4TCH theSttlmInf;
            theSttlmInf = this.getSttlmInf();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "sttlmInf", theSttlmInf), currentHashCode, theSttlmInf);
        }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ActiveCurrencyAndAmount theTtlIntrBkSttlmAmt;
            theTtlIntrBkSttlmAmt = this.getTtlIntrBkSttlmAmt();
            strategy.appendField(locator, this, "ttlIntrBkSttlmAmt", buffer, theTtlIntrBkSttlmAmt);
        }
        {
            XMLGregorianCalendar theIntrBkSttlmDt;
            theIntrBkSttlmDt = this.getIntrBkSttlmDt();
        ...
        }
        {
            SettlementInstruction4TCH theSttlmInf;
            theSttlmInf = this.getSttlmInf();
            strategy.appendField(locator, this, "sttlmInf", buffer, theSttlmInf);
        }
        return buffer;
    }
