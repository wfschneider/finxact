 ...
 * Transaction
 * <p>
 * Balanced financial transaction
 * 
 */
...
public class Trn {
    ...
    private OtherProperties__ otherProperties;
    /**
     ...
     * Transaction entries
     * <p>
     * Individual debit and credit transaction items
     * 
     */
    @JsonProperty("entries")
    @JsonPropertyDescription("Individual debit and credit transaction items")
    private List<Entry> entries = new ArrayList<Entry>();
    @JsonProperty("x-reportDbInterface")
    private Object xReportDbInterface;
    @JsonIgnore
     ...
     */
    @JsonProperty("otherProperties")
    public OtherProperties__ getOtherProperties() {
     ...
     */
    @JsonProperty("otherProperties")
    public void setOtherProperties(OtherProperties__ otherProperties) {
    ...
    @JsonProperty("x-reportDbInterface")
    public Object getXReportDbInterface() {
        return xReportDbInterface;
    }

    @JsonProperty("x-reportDbInterface")
    public void setXReportDbInterface(Object xReportDbInterface) {
        this.xReportDbInterface = xReportDbInterface;
    }
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(network).append(glJrnlDate).append(effectDtm).append(settleDtm).append(batchId).append(workItem).append(order).append(reverseId).append(trnCode).append(eft).append(mode).append(terminal).append(bill).append(note).append(attachments).append(tags).append(otherProperties).append(id).append(entries).append(xReportDbInterface).append(additionalProperties).toHashCode();
    }
